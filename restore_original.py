...
original_index_buttons = """<button onclick="window.print()" class="btn shadow" style="background-color: #0e3167; color: white;" title="Print PDF">
...
for file in os.listdir(dir_path):
    if file.endswith(".html"):
        ...
        content = pattern.sub(original_index_buttons + "                    ", content)
