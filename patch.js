...
let content = fs.readFileSync('generate_site_dynamic.js', 'utf8');
...
fs.writeFileSync('generate_site_dynamic.js', content, 'utf8');
console.log("generate_site_dynamic.js updated successfully!");
